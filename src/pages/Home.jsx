...
<Navbar></Navbar>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
        ...
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="relative z-10 w-full max-w-[60%] text-center space-y-10 top-7"
        >
      ...
      {/* STATS SECTION */}
      <section className="relative z-10 py-10 bg-white/[0.01] border-y border-white/5">
      ...
      <section id="services" className="relative bg-gray-100 text-[#002955] py-32 lg:py-48 px-4 overflow-hidden">
